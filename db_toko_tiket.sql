...
('RGL001', 'Tiket Reguler', 'Reguler', 150000, 20),
('vip004', 'VIP', 'VIP', 250000, 10),
('VVV001', 'Tiket VVIP', 'VVIP', 1500000000000, 3);
...
INSERT INTO `users` (`id`, `nama_lengkap`, `password`, `username`) VALUES
